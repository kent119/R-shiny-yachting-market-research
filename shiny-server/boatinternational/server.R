...
source("/srv/shiny-server/boatinternational/cleaning/clean_data.R")
load("/srv/shiny-server/boatinternational/data/data.Rda")
...
shinyServer(function(input, output, session) {
  ...
  yachts_filted <- reactive({
    ...
    #input_builder <- grep(input$text_builder, yachts$builder, ignore.case = TRUE)
    #input_name <- grep(input$text_name, yachts$name, ignore.case = TRUE)
    #selected_yachts$selected_builder <- ""
    #selected_yachts$selected_builder[input_builder] <- as.character(selected_yachts$builder[input_builder])
    #selected_yachts$selected_name[input_name] <- selected_yachts$name[input_name]
    ...
    selected_yachts <- selected_yachts[selected_yachts$price >= selected_price_min,]
    selected_yachts <- selected_yachts[selected_yachts$price <= selected_price_max,]
